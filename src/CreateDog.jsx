      ...
      <div className="createDogContainer">
        <div>
          ...
          <form className="createDogForm" onSubmit={this.handleSubmit}>
            ...
            <div className="createDogCategories">Gender</div>
            <div>
              <select
                className="createDogInput"
                value={this.state.value}
            ...
            <div className="createDogCategories">What does your dog likes</div>
            <div>
              <input
                className="createDogInputText"
                type="text"
            ...
            <div className="createDogCategories">What are you looking for?</div>
            <div>
              <input
                className="createDogInputText"
                type="text"
